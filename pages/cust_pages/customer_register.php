                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        <div class="form-group">
                                            <input type="password" name="ssn" id="ssn" class="form-control form-control-lg" placeholder="098-76-5432" pattern="[0-9]{3}-[0-9]{2}-[0-9]{4}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-1 pb-2">
                                        <div class="form-group">
                                            <input type="tel" name="phone" id="phone" class="form-control form-control-lg" placeholder="(123) 456-7890" pattern="\([0-9]{3}\) [0-9]{3}-[0-9]{4}" required />
